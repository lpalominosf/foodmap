...
*/
  ...
  function filterSelection(c) {
    ...
    for (i = 0; i < x.length; i++) {
      assetsRemoveClass(x[i], "show");
      if (x[i].className.indexOf(c) > -1) assetsAddClass(x[i], "show");
    }
  }

  // Show filtered elements
  function assetsAddClass(element, name) {
    var i, arr1, arr2;
  ...
  function assetsRemoveClass(element, name) {
    var i, arr1, arr2;
    arr1 = element.className.split(" ");
    arr2 = name.split(" ");
    for (i = 0; i < arr2.length; i++) {
